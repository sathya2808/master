...
module "asg_psp" {
    ...
    min_size                = "${var.psp_min_size}"
    max_size                = "${var.psp_max_size}"
...
module "asg_lifecycle_hook" {
  ...
  autoscaling_group_name    = "${module.asg_psp.asg_arn}"
...
module "launch_template" {
  ...
  instance_type                         = "${var.psp_insta_type}"
  availability_zones                    = "${var.availability_zones}"
...
module "r53_record_pub" {
  source       = "../../../../modules/r53_records"
  zone_id      = "${var.external_zone_id}"
  name         = "${var.public_dns_record_name}"
...
output "dns_name" {
  ...
  value       = "${module.r53_record_pub.r53_domain_name}"
}
